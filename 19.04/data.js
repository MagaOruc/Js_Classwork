...
// console.log(countries_data.sort((a,b)=> b.area-a.area).slice());


// console.log(countries_data.sort((a,b)=> b.population-a.population).slice(0,10));
 
// let lang=countries_data.filter((el)=> el.languages.includes("English"));
// console.log(lang);


// let langTwo=countries_data.filter((el)=> el.region == 'Asia' || el.region=='Europe');
// console.log(langTwo);
 let newArrey=


// console.log(countries_data.name );
